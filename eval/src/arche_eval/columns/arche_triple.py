"""컬럼 (6) Arche Triple — combined ⊕ aug 합본 (PoC).

배경:
  smoke run0 에서 combined 와 arche_aug 가 둘 다 81.0% 인데 *서로 다른
