...
Claude Code 플러그인으로 진행합니다. 다른 방식은 이 문서를 끝낸 뒤 [에이전트와 연결하기](/integrate/agent)에서 고르면 됩니다.
...
**처음 연결할 때 몇 초 걸립니다.** uv 가 Arche 와 의존성을 받는 시간입니다. 그다음부터는 1 초 안쪽으로 뜹니다.
...
답에는 어느 문서에서 온 사실인지가 함께 나옵니다. 노드마다 출처가 기록돼 있어서입니다.
